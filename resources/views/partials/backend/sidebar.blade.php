<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="@yield('activeBoatManagement') nav-item"><a href="#"><i class="la la-users"></i><span
                        class="menu-title">{{ __('Boat management') }}</span></a>

                <ul class="menu-content">
                    <li class="@yield('activebooking_list') nav-item">
                        <a href="{{ route('admin.boats') }}">
                            <i class="la la-money"></i>
                            <span class="menu-title">{{ __('Boats list') }}</span>
                        </a>
                    </li>
                    <li class="@yield('activebooking_list') nav-item">
                        <a href="{{ route('admin.amenities') }}">
                            <i class="la la-money"></i>
                            <span class="menu-title">{{ __('Amenities list') }}</span>
                        </a>
                    </li>
                    <li><a class="menu-item" href="{{ route('category.list', \App\Models\Category::TYPE_BOAT) }}">
                            <i class="la la-money"></i>
                            {{ __('Boat Category') }}
                        </a>
                    </li>
            ...
            <li class="@yield('activePlace') nav-item"><a href="#"><i class="la la-users"></i><span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="#">{{ __('Offers') }}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ route('offer_list') }}">{{ __('Offers List') }}</a>
                            </li>
                            <li><a class="menu-item"
                    ...
                    <li><a class="menu-item" href="{{ route('admin.city.index') }}">{{ __('Cities List') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('admin.country_index') }}">{{ __('Countries List') }}</a>
                    </li>
                </ul>
            </li>

            <li class="@yield('activePageManagenent') nav-item"><a href="#"><i class="la la-bank"></i><span
                        class="menu-title">{{ __('Page Managenent') }} </span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{ route('home_settings') }}">
                            {{ __('Home Settings') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('slides.index') }}">{{ __('Home Slides') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('post_list_blog') }}">{{ __('All Posts') }}</a>
                    </li>
                    <li><a class="menu-item"
                            href="{{ route('category.list', \App\Models\Category::TYPE_POST) }}">{{ __('Categories List') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('post_list_page') }}">{{ __('Pages Management') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('admin.faq.index') }}">{{ __('Faq') }}</a>
                    </li>
                </ul>
            </li>
