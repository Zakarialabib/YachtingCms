<div class="p-5">
    ...
    <form wire:submit.prevent="submit" class="flex items-center mt-12 justify-center">
        ...
        <button
            class="w-32 rounded-l-none hover:bg-blue-600 bg-blue-700 rounded sm:text-sm text-md font-medium leading-none text-white p-3 uppercase focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700 shadow-md">
            <span>
