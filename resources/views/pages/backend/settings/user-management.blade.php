                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="sur_name" type="text" class="form-control"
                                                placeholder="{{ __('Surname (Family name)') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="first_name" type="text" class="form-control"
                                                placeholder="{{ __('First name (Your name)') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                ...
                <div class="card-header">
                    ...
                    <div class="title_right">
                        <div class="pull-right">
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#create-user">Create New
                                User</button>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @foreach ($users as $serial => $user)
                                    <div class="modal fade text-left edit_user_{{ $user->user_id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg" style="padding: 60px;" role="document">
                                            <div class="modal-content">
                                                <form method="POST" action="{{ url('/settings/users/update-user') }}">
                                                    ...
                                                    <div class="modal-header">
                                                        <h3 class="modal-title" id="myModalLabel17">
                                                            {{ __('Create User') }}</h3>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="name" type="text"
                                                                            value="{{ $user->name }}"
                                                                            class="form-control"
                                                                            placeholder="First name (Your name)" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn grey btn-outline-secondary"
                                                            data-dismiss="modal">{{ __('Close') }}</button>
                                                        <button type="submit"
                                                            class="btn btn-outline-primary">{{ __('Update User') }}</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <button class="dropdown-item btn edit_user" data-toggle="modal"
                                                        data-target=".edit_user_{{ $user->user_id }}"
                                                        value="{{ $user->user_id }}"><i class="la la-edit"></i>
                                                        {{ __('Edit') }}</button>
                                                </div>
                                            </div>
                                        </td>
