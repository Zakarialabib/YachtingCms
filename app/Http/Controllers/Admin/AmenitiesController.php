...
class AmenitiesController extends Controller
{
    ...
    {
        return view('pages.backend.amenities.index');
    }

    public function edit(Amenities $amenity)
    {
        return view('pages.backend.amenities.edit', compact('amenity'));
    }    
    public function add()
    {
        return view('pages.backend.amenities.add');
    }    
    public function search()
    {
        return view('pages.backend.amenities.search');
    }    
